 ...
 * 
 * PASO 1: Actualizar events.module.ts
 * Abre src/events/events.module.ts y cámbialo por lo que hay al final de este archivo:


 * PASO 2: Actualizar app.module.ts
  * Abre src/app.module.ts y cámbialo por lo que hay al final de este archivo
